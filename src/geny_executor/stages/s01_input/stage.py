"""Stage 1: Input — receives, validates, normalizes user input."""
...
from geny_executor.stages.s01_input.validators import DefaultValidator, InputValidator
from geny_executor.stages.s01_input.normalizers import DefaultNormalizer, InputNormalizer
